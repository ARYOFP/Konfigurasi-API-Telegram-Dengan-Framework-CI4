...
class Notifikasi extends Controller
{
    ...
    public function index()
    {
        ...
        $this->kirimNotifikasi("Perhatian: Dosen tidak dapat mengisi sesi hari ini.");
        return view('notifikasi_view', ['message' => 'Notifikasi telah dikirim.']);
    }

    public function dosenTidakMasuk($dosen_id)
    {
        return $this->kirimPesanDosen($dosen_id, "TIDAK HADIR");
    }

    public function dosenMasuk($dosen_id)
    {
        return $this->kirimPesanDosen($dosen_id, "AKAN HADIR MENGISI JADWAL KULIAH");
    }
    ...
    private function kirimPesanDosen($dosen_id, $status)
    {
        ...
        $message = "Pemberitahuan Mahasiswa Semester VI, Untuk Dosen: " . $dosen['Nama_Dosen'] . ", Matakuiah: " . $dosen['Matakuiah'] . " " . $status . " hari ini.";
