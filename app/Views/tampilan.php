...
<head>
    ...
    <title>Dosen Universitas Xnxx</title>
    <!-- AdminLTE CSS -->
            ...
            <div class="sidebar">
                <nav class="mt-2">
                    <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu">
                        ...
                        <li class="nav-item">
                            <a href="/tambah-data-dosen" class="nav-link active">
                                        ...
                                        <tbody id="dosenTable">
                                            <?php foreach ($DataDosen as $key => $dosen) : ?>
                                                <tr>
                                                    ...
                                                    <td><?php echo $dosen['Matakuiah'] ?></td>
                                                    <td class="text-center">
                                                        <a href="notifikasi/dosen-masuk/<?= $dosen['Id_Dosen']; ?>" class="btn btn-success btn-sm"><i class="fas fa-check"></i> Segera Hadir</a>
                                                        <a href="notifikasi/dosen-tidak-masuk/<?= $dosen['Id_Dosen']; ?>" class="btn btn-danger btn-sm"><i class="fas fa-times"></i> Tidak Hadir</a>
                                                    </td>
                                                </tr>
                                            <?php endforeach ?>
                                        </tbody>
